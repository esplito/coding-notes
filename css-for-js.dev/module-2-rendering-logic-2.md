...
`display` does not render the element at all. If you hover it in the devtools you will not see it taking up space in the browser. (hint: it does not take up any space because it is not rendered)
...
This means that the parent can hide all of its children, but a child can still opt-out of this and become visible by setting `visibility: visible`.
...
#### A little trick for hiding content, but still having it screen reader accessible
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1MDMyMjY4NSwtOTI0ODg4NjcxLC0xOT
cwMDQwNTk5LC0xNzE0MTgxMDQ5LDEyODA0Mjc2NjMsMTE1OTE5
ODY1MSwtNjIxNTQzMzEzLDE1NzI3MDYzMjksLTM2NDc3ODEyNC
wxMTMyMDQ3NTIyLC0xOTIyMDAzNjM2LC0zMjkyNDYxNTQsODk4
OTU3Nzk3LDcyODk1ODQ0MywtNTU0Mzc4MTk5LC0xNjEyNzAwMj
Q2LC01NTI1OTc2ODUsMTk5ODA0NDg0MSw4Mjg0NTY2NTUsMTYw
MDg5OTM4N119
-->
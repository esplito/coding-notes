...
We can use `webpackPrefetch`, which is a webpack magic comment, to make the javascript file automatically load it into the browser cache.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMzcxOTQ4NzEsLTcyNjM0NjcxNywtMT

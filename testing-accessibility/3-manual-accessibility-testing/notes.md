...
>In its default Browse mode, using the right and left Arrow keys, NVDA will read one letter at a time. The up and down Arrow keys will navigate through static and interactive content.
>

...
By adding some configuration to the travis conf we can make sure that it uploads the code coverage files to codecov. (Check the lesson again if we want to use it with Travis CI)



> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4NzE3MTU0NSwtMTcwMDU1MTg5NywxOT
